...
function useFormControlProvider(props) {
  ...
  const [isFocused, setFocus2] = (0, import_react31.useState)(false);
...
function useHighlight(props) {
  ...
  return (0, import_react72.useMemo)(() => highlightWords({ text, query: query2 }), [text, query2]);
}
...
function Hide(props) {
  ...
  return (0, import_jsx_runtime78.jsx)(Visibility, { breakpoint: query2, hide: true, ssr, children });
}
...
function Show(props) {
  const { children, ssr } = props;
  const query2 = useQuery(props);
  return (0, import_jsx_runtime79.jsx)(Visibility, { breakpoint: query2, ssr, children });
}
